...
#   RS_INSTANCE_UUID:
#     Category: RightScale
#     Description: Universally-unique identifier for this server incarnation. Unique
#       across all clouds, partitions, and guaranteed to change after a bundled boot
#       or stop/start operation. Can be used as a sketchy or lumberjack hostname identifier.
#     Input Type: single
#     Required: false
#     Advanced: true
